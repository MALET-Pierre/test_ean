...
from ...suppl_delivery_gs1_labels.common import calculate_gs1_check_digit, GTIN_LENGTH, GTIN_14_LENGTH, GLN_LENGTH, SSCC_LENGTH, SSCC_EXTENSION_DIGIT
...
class QuantPackage(models.Model):
    ...
    def _compute_sscc_number(self):
        for quant in self:
            ...
            serial = self.env['ir.sequence'].next_by_code('suppl.gs1.sscc.number') or '0000000'
