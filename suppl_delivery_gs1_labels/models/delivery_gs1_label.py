...
import logging
from ...suppl_delivery_gs1_labels.common import GTIN_LENGTH, SSCC_LENGTH

_logger = logging.getLogger(__name__)


class GS1AbstractLabelPackageReport(models.AbstractModel):
    _name = 'base.report.suppl_delivery_gs1_labels'
...
class GS1LabelPackageReport(models.AbstractModel):
    _name = 'report.suppl_delivery_gs1_labels.gs1_label_package'
    _inherit = "base.report.suppl_delivery_gs1_labels"
    _description = 'Report model for GS1 labels with GS1 specification validation.'

    def _get_report_name_for_model(self):
        return 'suppl_delivery_gs1_labels.gs1_label_package'


class GS1LabelPickingReport(models.AbstractModel):
    _name = 'report.suppl_delivery_gs1_labels.gs1_label_picking'
    _inherit = "base.report.suppl_delivery_gs1_labels"
    _description = 'Report model for GS1 labels with GS1 specification validation.'

    def _get_report_name_for_model(self):
        return 'suppl_delivery_gs1_labels.gs1_label_picking'
